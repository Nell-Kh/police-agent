# police-agent — the POLICE (cop) agent

This repository submits **the POLICE (cop) agent** for the Police-Thief P2P league
(University of Haifa, "Orchestration of AI Agents", 2026). Its counterpart,
[`thief-agent`](https://github.com/Nell-Kh/thief-agent), submits the other role; the two repos share one
...
| Engineering | Value |
|---|---|
| Test suite | 972 tests collected (1 environment-dependent skip; the suite itself verifies this number) |
...
- **Tests & coverage:** 972 tests collected, 97.55% coverage against an 85%-floor gate that fails
